...
import pl.skeleton.composites.RegisterForm;
...
public class LoginForm extends VerticalLayout{
	...
	private void setupRegisterButton() {
		btnRegister.addClickListener(new ClickListener() {
			private static final long serialVersionUID = -5525505872736843629L;

			@Override
			public void buttonClick(ClickEvent event) {
				Window registerWindow = new Window("Register window");
				registerWindow.setSizeUndefined();
				registerWindow.setContent(new RegisterForm());
				registerWindow.setModal(true);
				registerWindow.setResizable(false);
				registerWindow.setWidth(300.0f, Unit.PIXELS);
				registerWindow.setHeight(320.0f, Unit.PIXELS);
				registerWindow.addStyleName("labels");
				registerWindow.addStyleName("login-panel");
